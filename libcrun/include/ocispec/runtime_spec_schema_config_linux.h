...
typedef struct {
    char **keys;
    runtime_spec_schema_defs_linux_net_device **values;
    size_t len;
}
runtime_spec_schema_config_linux_net_devices;

void free_runtime_spec_schema_config_linux_net_devices (runtime_spec_schema_config_linux_net_devices *ptr);

runtime_spec_schema_config_linux_net_devices *clone_runtime_spec_schema_config_linux_net_devices (runtime_spec_schema_config_linux_net_devices *src);
runtime_spec_schema_config_linux_net_devices *make_runtime_spec_schema_config_linux_net_devices (yajl_val tree, const struct parser_context *ctx, parser_error *err);

yajl_gen_status gen_runtime_spec_schema_config_linux_net_devices (yajl_gen g, const runtime_spec_schema_config_linux_net_devices *ptr, const struct parser_context *ctx, parser_error *err);
...
typedef struct {
    char **keys;
    runtime_spec_schema_defs_linux_rdma **values;
    size_t len;
}
...
typedef struct {
    ...
    unsigned int enable_monitoring_present : 1;
}
...
runtime_spec_schema_config_linux_memory_policy;

void free_runtime_spec_schema_config_linux_memory_policy (runtime_spec_schema_config_linux_memory_policy *ptr);

runtime_spec_schema_config_linux_memory_policy *clone_runtime_spec_schema_config_linux_memory_policy (runtime_spec_schema_config_linux_memory_policy *src);
runtime_spec_schema_config_linux_memory_policy *make_runtime_spec_schema_config_linux_memory_policy (yajl_val tree, const struct parser_context *ctx, parser_error *err);

yajl_gen_status gen_runtime_spec_schema_config_linux_memory_policy (yajl_gen g, const runtime_spec_schema_config_linux_memory_policy *ptr, const struct parser_context *ctx, parser_error *err);
...
typedef struct {
    ...
    runtime_spec_schema_config_linux_net_devices *net_devices;
    ...
    runtime_spec_schema_config_linux_memory_policy *memory_policy;
